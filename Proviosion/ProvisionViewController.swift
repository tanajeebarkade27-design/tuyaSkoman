...
class ProvisionViewController: UIViewController {
    ...
    func setWifiIconImageFor(cell: WifiListTableViewCell, network: ESPWifiNetwork) {
        ...
        if rssi > Int32(-50) {
            cell.signalImageView.image = UIImage(named: "Wifi_4")
        } else if rssi > Int32(-60) {
            cell.signalImageView.image = UIImage(named: "Wifi_3")
        } else if rssi > Int32(-67) {
            cell.signalImageView.image = UIImage(named: "Wifi_2")
        } else {
            cell.signalImageView.image = UIImage(named: "Wifi_1")
        }
    ...
    func showStatusScreen() {
        DispatchQueue.main.async {
            ...
            let statusVC = self.storyboard?
                .instantiateViewController(withIdentifier: "statusVC") as! StatusViewController
...
extension ProvisionViewController: UITableViewDelegate {
    ...
    func tableView(_: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.row >= wifiDetailList.count {
            ...
            print("SSID GOT HERE :====", ssid) /// _GOT_SSID_HERE
            
            userDefault.set(ssid, forKey: "ssid")
...
extension ProvisionViewController: UITableViewDataSource {
    func tableView(_: UITableView, numberOfRowsInSection _: Int) -> Int {
        ...
        print("wifi list\(wifiDetailList)")
    }
