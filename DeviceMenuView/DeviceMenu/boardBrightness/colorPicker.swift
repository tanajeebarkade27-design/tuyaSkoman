...
//        self.addSubview(selectedColorView)
        ...
        colorWheel = ColorWheel(frame: CGRect(x: 0, y: 0, width: colorWheelSize + 80, height: colorWheelSize + 80), color: self.color)
...
//        self.addSubview(brightnessView)
    ...
    func hueAndSaturationSelected(_ hue: CGFloat, saturation: CGFloat) {
        ...
        NotificationCenter.default.post(name: Notification.Name("ColorUpdate"), object: nil, userInfo: ["color": self.color!])
